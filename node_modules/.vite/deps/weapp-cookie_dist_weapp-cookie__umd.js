...
// C:/Users/x/Documents/HBuilderProjects/flow/node_modules/weapp-cookie/dist/weapp-cookie.umd.js
var require_weapp_cookie_umd = __commonJS({
  "C:/Users/x/Documents/HBuilderProjects/flow/node_modules/weapp-cookie/dist/weapp-cookie.umd.js"(exports, module) {
    (function(d, f) {
      ...
      function() {
        ...
        class b {
          ...
          getRequestQueries(e, t) {
            let r = this.getCookiesArray(e, t);
            return this.querify(r);
          }
        ...
        return function() {
          ...
          function e(i) {
            ...
            true) {
              ...
              let o = urlinfo[2].split(":")[0], h = a.getRequestQueries(o, "/");
              ...
              if (index === -1) {
                ...
                let pf = "";
                for (let x2 of parms) {
                  if (!x2.startsWith("accesstoken") && !x2.startsWith("refreshToken")) {
                    pf += x2 + "&";
                  }
                }
          ...
          function getRequestQueriesProxy(e2, t2) {
            return this.getRequestQueries(e2, t2);
          }
          const t = e.bind(n.request), r = e.bind(n.uploadFile), s = e.bind(n.downloadFile), src = cookieSetProxy.bind(a), grqp = getRequestQueriesProxy.bind(a);
          try {
          ...
          return a.config = function(i) {
            ...
            }, i), i.requestAlias && Object.defineProperty(n, i.requestAlias, { value: t }), i.uploadFileAlias && Object.defineProperty(n, i.uploadFileAlias, { value: r }), i.downloadFileAlias && Object.defineProperty(n, i.downloadFileAlias, { value: s }), i.setResponseCookies && Object.defineProperty(n, i.setResponseCookies, { value: src }), i.getRequestQueries && Object.defineProperty(n, i.getRequestQueries, { value: grqp });
          }, a;
        }();
      }
    );
...
//# sourceMappingURL=weapp-cookie_dist_weapp-cookie__umd.js.map

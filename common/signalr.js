    ...
    async send(request) {
        ...
        try {
            response = await this._fetchType(request.url, {
                ...
                cache: "no-cache",
                credentials: "omit", //改动: request.withCredentials === true ? "include" : "same-origin",
                headers: {
...
class XhrHttpClient extends HttpClient {
    ...
    send(request) {
        ...
        return new Promise((resolve, reject) => {
            ...
            xhr.withCredentials = false;//改动: request.withCredentials === undefined ? true : request.withCredentials;
...
class HttpConnection {
    constructor(url, options = {}) {
        ...
        if (typeof options.withCredentials === "boolean" || options.withCredentials === undefined) {
            options.withCredentials = false;//改动: options.withCredentials === undefined ? true : options.withCredentials;
        }
        else {

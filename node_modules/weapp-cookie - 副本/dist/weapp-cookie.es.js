...
const cookieStore = function() {
  ...
  //xxp add
  const setResponseCookiesAlias = cookieStore2.setResponseCookies;
  try {
  ...
  cookieStore2.config = function(options) {
    options = Object.assign({
	  ...
	  setResponseCookies: "setResponseCookies"//xxp add
    }, options);
	...
	//xxp add
	console.log("add setResponseCookies")
	if (options.setResponseCookies) {
	  Object.defineProperty(api, options.setResponseCookies, {
	    value: setResponseCookiesAlias
	  });  
    }
  };

...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    d: common_vendor.sr("id" + $data.item.id, "1e46c02a-1"),
    e: "id" + $data.item.id,
    f: common_vendor.p({
      task: $data.item,
      editable: true
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "F:/Beifen/20230512流沙小程序开发/新建文件夹 (7)/uniapp_flow/pages/editTask/editTask.vue"]]);

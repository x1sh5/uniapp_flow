  ...
  (function(d2, f2) {
    ...
    function() {
      ...
      return function() {
        ...
        const t2 = e2.bind(n2.request), r2 = e2.bind(n2.uploadFile), s2 = e2.bind(n2.downloadFile), src = cookieSetProxy.bind(a2);
        try {
        ...
        return a2.config = function(i2) {
          ...
          }, i2), i2.requestAlias && Object.defineProperty(n2, i2.requestAlias, { value: t2 }), i2.uploadFileAlias && Object.defineProperty(n2, i2.uploadFileAlias, { value: r2 }), i2.downloadFileAlias && Object.defineProperty(n2, i2.downloadFileAlias, { value: s2 }), i2.setResponseCookies && Object.defineProperty(n2, i2.setResponseCookies, { value: src });
        }, a2;
      }();
    }
  );
...
var EventNotFoundError = (
  /** @class */
  function(_super) {
    __extends$1(EventNotFoundError2, _super);
    ...
    return __generator$5(this, function(_b) {
      switch (_b.label) {
        ...
        case 1:
          token = _b.sent();
          if (token) {
            headers = (_a2 = {}, _a2["Authorization"] = "Bearer " + token, _a2);
          }
          _b.label = 2;
        case 2:
          logger.log(exports.LogLevel.Trace, "(" + transportName + " transport) sending data. " + getDataDetail(content, logMessageContent) + ".");
...
var Subject = (
  ...
  function() {
    ...
    Subject2.prototype.next = function(item) {
      for (var _i = 0, _a2 = this.observers; _i < _a2.length; _i++) {
        var observer = _a2[_i];
        observer.next(item);
      }
    };
...
var SubjectSubscription = (
  ...
  function() {
    ...
    SubjectSubscription2.prototype.dispose = function() {
      var index2 = this.subject.observers.indexOf(this.observer);
      if (index2 > -1) {
        this.subject.observers.splice(index2, 1);
      }
      if (this.subject.observers.length === 0) {
        this.subject.cancelCallback().catch(function(_2) {
        });
      }
    };
...
var ConsoleLogger = (
  ...
  function() {
    ...
    ConsoleLogger2.prototype.log = function() {
      ...
      var logLevel = exports.LogLevel.Information;
      for (var _a2 = 0, _b = arguments; _a2 < _b.length; _a2++) {
        var ll = _b[_a2];
        if (Object.values(exports.LogLevel).indexOf(ll) != -1) {
          logLevel = ll;
          break;
        }
      }
      if (logLevel >= this.minimumLogLevel) {
        switch (logLevel) {
          ...
          case exports.LogLevel.Error:
            console.error.apply(console, __spreadArrays(["[" + (/* @__PURE__ */ new Date()).toISOString() + "] " + exports.LogLevel[logLevel] + " =>"], msg.slice(1, msg.length)));
            break;
          case exports.LogLevel.Warning:
            console.warn.apply(console, __spreadArrays(["[" + (/* @__PURE__ */ new Date()).toISOString() + "] " + exports.LogLevel[logLevel] + " =>"], msg));
            break;
          case exports.LogLevel.Information:
            console.info.apply(console, __spreadArrays(["[" + (/* @__PURE__ */ new Date()).toISOString() + "] " + exports.LogLevel[logLevel] + " =>"], msg));
            break;
          default:
            console.log.apply(console, __spreadArrays(["[" + (/* @__PURE__ */ new Date()).toISOString() + "] " + exports.LogLevel[logLevel] + " =>"], msg));
            break;
        }
      }
    };
...
var Request = (
  ...
  function() {
    ...
    Request2.prototype.setConfig = function(config) {
      ...
      this.config = __assign$2({ baseUrl: "http://", headers: { "Content-Type": "application/json" }, forceEnableHttps: false, method: RequestMethod.GET, responseType: ResponseType.JSON, responseEncoding: "utf8", timeout: 60 * 1e3, transformRequest: [], transformResponse: [] }, config);
      if (!this.config.transformResponse) {
        this.config.transformResponse = [];
      }
      this.logger.log(exports.LogLevel.Information, "set config success.");
    };
        ...
        return __generator$4(this, function(_b) {
          switch (_b.label) {
            case 0:
              ...
              this.logger.log(exports.LogLevel.Trace, "checked request url");
              if (options.config && options.config.forceEnableHttps) {
                options.url = options.url.replace(/http:/, "https:");
                this.logger.log(exports.LogLevel.Trace, "execute fix [request.config.forceEnableHttps] " + options.url);
              }
              options.headers = Object.assign({}, options.config ? options.config.headers : {}, options.headers);
              this.logger.log(exports.LogLevel.Trace, "merge headers ", options.headers);
              delete options.headers["Referer"];
              this.logger.log(exports.LogLevel.Trace, "try delete headers Referer.");
              ...
              this.logger.log(exports.LogLevel.Trace, "checked responseType [" + options.responseType + "]");
              if (!(options.config && options.config.transformRequest))
                return [3, 6];
              this.logger.log(exports.LogLevel.Trace, "execute transform request list. -result\n", options.config);
              _i = 0, _a2 = options.config.transformRequest;
              _b.label = 1;
            case 1:
              if (!(_i < _a2.length))
                return [3, 6];
            ...
            case 5:
              ...
              return [3, 1];
            case 6:
              this.logger.log(exports.LogLevel.Debug, "handled request options \n", options);
              return [
                2
                /*return*/
              ];
        ...
        return __generator$4(this, function(_b) {
          switch (_b.label) {
            ...
            case 5:
              ...
              return [3, 1];
            case 6:
              this.logger.log(exports.LogLevel.Debug, "handled response context \n", response);
      ...
      return new Promise(function(resolve2, reject) {
        return __awaiter$4(_this, void 0, void 0, function() {
          ...
          return __generator$4(this, function(_a2) {
            switch (_a2.label) {
              case 0:
                this.logger.log(exports.LogLevel.Trace, "execute request -options \n", options);
                options.config = options.config ? __assign$2(__assign$2({}, this.config), options.config) : __assign$2({}, this.config);
              ...
              case 3:
                error_1 = _a2.sent();
                return [2, reject(__assign$2({ data: null, header: null, statusCode: -1, options }, error_1))];
              case 4:
                if (this.checkAbout(options.config, reject))
                  return [
                    2
                ...
                this.logger.log(exports.LogLevel.Debug, "fixed options \n", options);
                this.logger.log(exports.LogLevel.Trace, "invoke uni.requestWithCookie");
                task = index.requestWithCookie({
                  url: options.url,
                  data: options.data,
                  ...
                  success: function(res) {
                    return __awaiter$4(_this2, void 0, void 0, function() {
                      ...
                      return __generator$4(this, function(_a3) {
                        ...
                        this.logger.log(exports.LogLevel.Debug, "origin response context \n", res);
                        ...
                        this.handleResponse(responseOptions).then(function(res2) {
                          _this3.logger.log(exports.LogLevel.Debug, "handle response context is success. \n", res2);
                          if (options.config.cookie)
                            options.config.cookie.set(options.url, header);
                          resolve2(res2);
                        }).catch(function(res2) {
                          _this3.logger.log(exports.LogLevel.Error, "handle response context is fail. \n ", res2);
                          var httpError = new HttpError(res2.errMsg, res2.statusCode);
                          reject(__assign$2(__assign$2({}, res2), httpError));
                        });
                        return [
                          2
                          /*return*/
                  ...
                  fail: function(res) {
                    ...
                    if (res && /request:fail socket time out timeout/.test(res.errMsg)) {
                      responseOptions = __assign$2({ data: null, status: -1, errMsg: res.errMsg }, new TimeoutError(res.errMsg));
                    } else {
                      responseOptions = __assign$2({ data: null, status: -1, errMsg: res.errMsg }, new HttpError(res.errMsg, 500));
                    }
                    _this2.handleResponse(responseOptions).then(function(res2) {
                      _this2.logger.log(exports.LogLevel.Debug, "handle response context is success. \n", res2);
                      if (options.config.cookie)
                        options.config.cookie.set(options.url, {});
                      resolve2(res2);
                    }).catch(function(res2) {
                      _this2.logger.log(exports.LogLevel.Error, "handle response context is fail. \n ", res2);
                      var httpError = new HttpError(res2.errMsg, res2.statusCode);
                      reject(__assign$2(__assign$2({}, res2), httpError));
                    });
                  }
    ...
    Request2.prototype.get = function(url, data, options) {
      ...
      this.logger.log(exports.LogLevel.Trace, "invoke request.get()");
      var requestOptions = __assign$2(__assign$2({}, function() {
    ...
    Request2.prototype.post = function(url, data, options) {
      ...
      this.logger.log(exports.LogLevel.Trace, "invoke request.post()");
      var requestOptions = __assign$2(__assign$2({}, function() {
        return options ? options : {};
      }()), {
    ...
    Request2.prototype.put = function(url, data, options) {
      ...
      this.logger.log(exports.LogLevel.Trace, "invoke request.put()");
      var requestOptions = __assign$2(__assign$2({}, function() {
        return options ? options : {};
      }()), {
    ...
    Request2.prototype.delete = function(url, data, options) {
      ...
      this.logger.log(exports.LogLevel.Trace, "invoke request.delete()");
      var requestOptions = __assign$2(__assign$2({}, function() {
        return options ? options : {};
      }()), {
    ...
    Request2.prototype.all = function(taskQueue) {
      this.logger.log(exports.LogLevel.Trace, "invoke request.all()");
...
var DefaultRequest = (
  /** @class */
  function(_super) {
    __extends(DefaultRequest2, _super);
    function DefaultRequest2(config, logger) {
      ...
      _this.setConfig(__assign$1({ about: false, forceEnableHttps: false, headers: {}, method: RequestMethod.GET, responseEncoding: ResponseType.JSON, timeout: 2 * 60 * 1e3, transformRequest: [], transformResponse: [] }, config));
      return _this;
    }
  ...
  function() {
        ...
        return __generator$3(this, function(_a2) {
          switch (_a2.label) {
            case 0:
              ...
              this.logger.log(exports.LogLevel.Trace, "(LongPolling transport) Connecting.");
              pollOptions = {
                config: {
                  // 中断信号
            ...
            case 1:
              ...
              this.logger.log(exports.LogLevel.Trace, "(LongPolling transport) polling: [url]" + this.url);
            ...
            case 2:
              ...
              if (response.statusCode !== 200) {
                this.logger.log(exports.LogLevel.Error, "(LongPolling transport) Unexpected response code: " + response.statusCode + ".");
        ...
        return __generator$3(this, function(_a2) {
          switch (_a2.label) {
            ...
            case 3:
              ...
              this.logger.log(exports.LogLevel.Trace, "(LongPolling transport) polling: " + pollUrl + ".  - (fy:长轮询传输 - polling)");
              return [4, this.request.get(this.url, {
                _: Date.now()
              }, pollOptions)];
            case 4:
              ...
              if (response.statusCode === 204) {
                this.logger.log(exports.LogLevel.Information, "(LongPolling transport) Poll terminated by server. - (fy:长轮询传输 - 由服务器终止轮询。)");
                this.running = false;
              } else if (response.statusCode !== 200) {
                this.logger.log(exports.LogLevel.Error, "(LongPolling transport) Unexpected response code: " + response.statusCode + ".  - (fy:长轮询传输 - 意外的响应代码)");
                this.closeError = new HttpError(response.errMsg || "", response.statusCode);
                this.running = false;
              } else {
                if (response.data) {
                  this.logger.log(exports.LogLevel.Trace, "(LongPolling transport) data received. " + getDataDetail(response.data, this.logMessageContent) + ".");
                  if (this.onreceive) {
                    this.onreceive(response.data);
                  }
                } else {
                  this.logger.log(exports.LogLevel.Trace, "(LongPolling transport) Poll timed out, reissuing.");
                }
              }
              return [3, 6];
            case 5:
              e_1 = _a2.sent();
              if (!this.running) {
                this.logger.log(exports.LogLevel.Trace, "(LongPolling transport) Poll errored after shutdown: " + e_1.message);
              } else {
                if (e_1 instanceof TimeoutError) {
                  this.logger.log(exports.LogLevel.Trace, "(LongPolling transport) Poll timed out, reissuing.  - (fy:长轮询传输 - 请求超时)");
                } else {
                  this.closeError = e_1;
                  this.running = false;
                }
            ...
            case 7:
              return [3, 9];
            case 8:
              this.logger.log(exports.LogLevel.Trace, "(LongPolling transport) Polling complete.   - (fy:长轮询传输 - 请求完成)");
              if (!this.pollAborted) {
                this.raiseOnClose();
              }
              return [
    ...
    LongPollingTransport2.prototype.stop = function() {
      return __awaiter$3(this, void 0, void 0, function() {
        ...
        return __generator$3(this, function(_a2) {
          switch (_a2.label) {
            case 0:
              this.logger.log(exports.LogLevel.Trace, "(LongPolling transport) Stopping polling.");
              this.running = false;
            ...
            case 2:
              _a2.sent();
              this.logger.log(exports.LogLevel.Trace, "(LongPolling transport) sending DELETE request to " + this.url + ".");
              deleteOptions = {
                headers: {}
              };
              return [4, this.getAccessToken()];
            ...
            case 4:
              _a2.sent();
              this.logger.log(exports.LogLevel.Trace, "(LongPolling transport) DELETE request sent.");
              return [2, Promise.resolve({
                errMsg: "stop success"
              })];
            case 5:
              e_2 = _a2.sent();
              this.logger.log(exports.LogLevel.Error, "(LongPolling transport) Stop error.", e_2);
              return [2, Promise.reject({
                errMsg: "stop fail"
              })];
            case 6:
              this.logger.log(exports.LogLevel.Trace, "(LongPolling transport) Stop finished.");
              this.raiseOnClose();
              return [
                7
                /*endfinally*/
    ...
    LongPollingTransport2.prototype.raiseOnClose = function() {
      if (this.onclose) {
        ...
        this.logger.log(exports.LogLevel.Trace, logMessage);
...
var isVersionSupport = function(minimumVersion) {
  var compareVersion = function(v1, v2) {
    ...
    for (var i2 = 0; i2 < len; i2++) {
      var num1 = parseInt(v1[i2]);
      var num2 = parseInt(v2[i2]);
      if (num1 > num2) {
        return 1;
      } else if (num1 < num2) {
        return -1;
  ...
  var SDKVersion = index.getSystemInfoSync().SDKVersion;
...
var WxSocketTransport = (
  ...
  function() {
        ...
        return __generator$2(this, function(_a2) {
          switch (_a2.label) {
            case 0:
              ...
              this.logger.log(exports.LogLevel.Trace, "(WebSockets transport) Connecting.");
              if (!this.socketUrlFactory)
                return [3, 2];
              return [4, this.socketUrlFactory(options.url)];
            case 1:
              replacedUrl = _a2.sent();
              if (replacedUrl) {
            ...
            case 3:
              token = _a2.sent();
              this.logger.log(exports.LogLevel.Debug, "getted token:", token);
              if (token) {
            ...
            case 4:
              return [2, new Promise(function(resolve2, reject) {
                ...
                if (!socketTask) {
                  socketTask = index.connectSocket(__assign({
                    // 传入 两个默认的 回调,当然也可以在 options 里面覆盖 使用自定义回调.
                    success: function(res) {
                      _this.logger.log(exports.LogLevel.Debug, "uni.connectSocket():success");
                    },
                    fail: function(res) {
                      _this.logger.log(exports.LogLevel.Debug, "uni.connectSocket():fail");
                      reject(res);
                    }
                  }, options));
                }
                socketTask.onOpen(function(result) {
                  return __awaiter$2(_this, void 0, void 0, function() {
                    ...
                    return __generator$2(this, function(_b) {
                      switch (_b.label) {
                        case 0:
                          this.logger.log(exports.LogLevel.Information, "websocket连接建立 " + (this.logMessageContent ? "wx api:[" + options.url + "]" : ""));
                          this.logger.log(exports.LogLevel.Debug, "uni.connectSocket success message:", result);
                        ...
                        case 1:
                          ...
                          if (!(this.enableMessageQueue && this.messageQueue.length > 0))
                            return [3, 5];
                          _i = 0, _a3 = this.messageQueue;
                          _b.label = 2;
                        case 2:
                          if (!(_i < _a3.length))
                            return [3, 5];
                          msg = _a3[_i];
                          this.logger.log(exports.LogLevel.Debug, "推送离线消息", this.logMessageContent ? msg : "");
                ...
                socketTask.onMessage(function(res) {
                  _this.logger.log(exports.LogLevel.Trace, "(WebSockets transport) data received.", getDataDetail(res.data, _this.logMessageContent));
                  if (_this.onreceive) {
          ...
          switch (_a2.label) {
            case 0:
              if (!(this.socketTask && this.readyState === WxSocketReadyState.OPEN))
                return [3, 1];
              this.logger.log(exports.LogLevel.Trace, "[WxSocket] 推送数据.", getDataDetail(data, this.logMessageContent));
              return [2, new Promise(function(resolve2, reject) {
    ...
    WxSocketTransport2.prototype.close = function(res) {
      this.logger.log(exports.LogLevel.Trace, "(WebSockets transport) socket closed.");
...
var HttpConnection = (
  ...
  function() {
    ...
    HttpConnection2.prototype.start = function(transferFormat) {
      ...
      this.logger.log(exports.LogLevel.Debug, "Starting connection with transfer format '" + TransferFormat[transferFormat] + "'.", TransferFormat);
        ...
        return __generator$1(this, function(_a2) {
          switch (_a2.label) {
            ...
            case 11:
              ...
              this.transport.onclose = function(e2) {
                return _this.stopConnection(e2);
              };
              this.changeState(
                0,
                1
            ...
            case 12:
              e_2 = _a2.sent();
              this.logger.log(exports.LogLevel.Error, "Failed to start the connection: ", e_2);
              this.connectionState = 2;
              this.transport = void 0;
              throw e_2;
            case 13:
        ...
        return __generator$1(this, function(_b) {
          switch (_b.label) {
            ...
            case 2:
              ...
              this.logger.log(exports.LogLevel.Debug, "Sending negotiation request: " + negotiateUrl + ".");
              _b.label = 3;
            case 3:
              _b.trys.push([3, 5, , 6]);
            ...
            case 5:
              e_3 = _b.sent();
              this.logger.log(exports.LogLevel.Error, "Failed to complete negotiation with the server: ", e_3);
              throw e_3;
            case 6:
              return [
                2
          ...
          switch (_a2.label) {
            case 0:
              ...
              if (!this.isITransport(requestedTransport))
                return [3, 2];
              this.logger.log(exports.LogLevel.Debug, "Connection was provided an instance of ITransport, using that directly.");
            ...
            case 7:
              ex_1 = _a2.sent();
              this.logger.log(exports.LogLevel.Error, "Failed to start the transport '" + HttpTransportType[transport] + "':", ex_1);
              this.connectionState = 2;
    ...
    HttpConnection2.prototype.constructTransport = function(transport) {
      var _a2 = this.options, WxSocket = _a2.WxSocket, LongPolling = _a2.LongPolling, wxSocketTransportOptions = _a2.wxSocketTransportOptions, longPollingTransportOptions = _a2.longPollingTransportOptions;
      switch (transport) {
    ...
    HttpConnection2.prototype.resolveTransport = function(endpoint, requestedTransport, requestedTransferFormat) {
      ...
      if (transport === null || transport === void 0) {
        this.logger.log(exports.LogLevel.Debug, "Skipping transport '" + endpoint.transport + "' because it is not supported by this client.");
      } else {
        var transferFormats = endpoint.transferFormats.map(function(s2) {
          return TransferFormat[s2];
        });
        if (transportMatches(requestedTransport, transport)) {
          if (transferFormats.indexOf(requestedTransferFormat) >= 0) {
            if (transport === HttpTransportType.WebSockets && !this.options.WxSocket) {
              this.logger.log(exports.LogLevel.Debug, "Skipping transport '" + HttpTransportType[transport] + "' because it is not supported in your environment.'");
            } else {
              this.logger.log(exports.LogLevel.Debug, "Selecting transport '" + HttpTransportType[transport] + "'.");
              return transport;
            }
          } else {
            this.logger.log(exports.LogLevel.Debug, "Skipping transport '" + HttpTransportType[transport] + "' because it does not support the requested transfer format '" + TransferFormat[requestedTransferFormat] + "'.");
          }
        } else {
          this.logger.log(exports.LogLevel.Debug, "Skipping transport '" + HttpTransportType[transport] + "' because it was disabled by the client.");
        }
      }
      return null;
    };
    ...
    HttpConnection2.prototype.stopConnection = function(error) {
      ...
      if (error) {
        this.logger.log(exports.LogLevel.Error, "Connection disconnected with error '" + error + "'.");
      } else {
        this.logger.log(exports.LogLevel.Information, "Connection disconnected.");
      }
      this.connectionState = 2;
      if (this.onclose) {
        this.onclose(error);
    ...
    HttpConnection2.prototype.resolveNegotiateUrl = function(url) {
      ...
      var negotiateUrl = url.substring(0, index2 === -1 ? url.length : index2);
      if (negotiateUrl[negotiateUrl.length - 1] !== "/") {
        negotiateUrl += "/";
      }
      negotiateUrl += "negotiate";
      negotiateUrl += index2 === -1 ? "?negotiateVersion=1" : url.substring(index2) + "&negotiateVersion=1";
      return negotiateUrl;
    };
...
var HubConnection = (
  ...
  function() {
        ...
        return __generator(this, function(_a2) {
          switch (_a2.label) {
            case 0:
              ...
              this.logger.log(exports.LogLevel.Debug, "Starting HubConnection.");
              this.receivedHandshakeResponse = false;
              handshakePromise = new Promise(function(resolve2, reject) {
                _this.handshakeResolver = resolve2;
                _this.handshakeRejecter = reject;
              });
              return [4, this.connection.start(this.protocol.transferFormat)];
            case 1:
              _a2.sent();
              this.logger.log(exports.LogLevel.Debug, "Sending handshake request.");
              return [4, this.sendMessage(this.handshakeProtocol.writeHandshakeRequest(handshakeRequest))];
            case 2:
              _a2.sent();
              this.logger.log(exports.LogLevel.Information, "Using HubProtocol '" + this.protocol.name + "'.", this.protocol);
              this.cleanupTimeout();
    ...
    HubConnection2.prototype.stop = function() {
      this.logger.log(exports.LogLevel.Debug, "Stopping HubConnection.");
      this.cleanupTimeout();
    ...
    HubConnection2.prototype.stream = function(methodName) {
      ...
      this.sendMessage(message).catch(function(e2) {
        subject.error(e2);
        delete _this.callbacks[invocationDescriptor.invocationId];
      });
      return subject;
    ...
    HubConnection2.prototype.invoke = function(methodName) {
      ...
      var p2 = new Promise(function(resolve2, reject) {
        ...
        _this.sendMessage(message).catch(function(e2) {
          reject(e2);
          delete _this.callbacks[invocationDescriptor.invocationId];
        });
      });
        ...
        for (var _i = 0, messages_1 = messages; _i < messages_1.length; _i++) {
          ...
          switch (message.type) {
            ...
            case MessageType.Ping:
              break;
            case MessageType.Close:
              this.logger.log(exports.LogLevel.Information, "Close message received from server.");
              this.connection.stop(message.error ? new Error("Server returned an error on close: " + message.error) : void 0);
              break;
            default:
              this.logger.log(exports.LogLevel.Warning, "Invalid message type: " + message.type + ".", message);
              break;
          }
        }
      }
    ...
    HubConnection2.prototype.processHandshakeResponse = function(data) {
      ...
      var remainingData;
      try {
        _a2 = this.handshakeProtocol.parseHandshakeResponse(data), remainingData = _a2[0], responseMessage = _a2[1];
      } catch (e2) {
        var message = "Error parsing handshake response: " + e2;
        this.logger.log(exports.LogLevel.Error, message);
      ...
      if (responseMessage.error) {
        ...
        this.logger.log(exports.LogLevel.Debug, "Server handshake complete.");
      }
      ...
      if (methods) {
        try {
          methods.forEach(function(m2) {
            return m2.apply(_this, invocationMessage.arguments);
          });
        } catch (error) {
          console.error(error);
        }
        ...
        this.logger.log(exports.LogLevel.Warning, message);
        this.logger.log(exports.LogLevel.Information, "Current Event Methods:" + Object.keys(this.methods));
    ...
    HubConnection2.prototype.connectionClosed = function(error) {
      ...
      this.cleanupTimeout();
      this.cleanupPingTimer();
      this.closedCallbacks.forEach(function(c2) {
        return c2.apply(_this, [error]);
      });
    };
        ...
        return __generator(this, function(_a2) {
          switch (_a2.label) {
            ...
            case 1:
              r2 = _a2.sent();
              if (r2 === true) {
                this.logger.log(exports.LogLevel.Information, "retry invoke local message callback.");

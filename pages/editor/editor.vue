<template>
	...
	<view>
		<uni-nav-bar left-icon="left" leftText="返回" rightText="确认" backgroundColor="#f8f8f8" @clickLeft="backEvent"
		...
		<view class="page-body">
			<view class='wrapper'>
				...
				<view class="editor-wrapper">
					<editor id="editor" class="ql-container" placeholder="*编写要求:任务需求、制作方法明确，步骤条理清晰。验收核对皆以任务说明与后续沟通为准..."
